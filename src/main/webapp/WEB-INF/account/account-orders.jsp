...
<head>
    ...
    <title>Orders & Invoices - SchemeCraft</title>
    ...
    <div class="account-layout">
        ...
        <nav class="account-sidebar" aria-label="Account Navigation">
            <ul class="account-tabs">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/account/orders" class="tab-link active">
        ...
        <section class="account-content">
            <div id="tab-orders" class="tab-content active">
                <div class="card-panel">
                    <h2 class="panel-title">Order History & Invoices</h2>
                    <p class="panel-description">Filter and inspect your orders, or download instant official invoices.</p>
                    ...
                    <form id="orderFilterForm" class="filter-bar">
                        ...
                        <div class="filter-actions">
                            <button type="submit" class="btn-action btn-sm btn-primary-action">Filter Orders</button>
                            <button type="button" id="btnResetOrderFilter" class="btn-action btn-sm btn-secondary-action">Reset</button>
                        </div>
                    </form>
...
<div id="modalOrderDetails" class="modal-overlay">
    <div class="modal-card modal-lg">
        <div class="modal-header">
            <h3 class="modal-title" id="orderDetailsTitle">Order Details</h3>
            <button type="button" class="modal-close" data-close-modal="modalOrderDetails">&times;</button>
        </div>
        <div class="modal-body" id="orderDetailsBody"></div>
        <div class="modal-actions">
            <button type="button" id="btnPrintInvoiceFromModal" class="btn-action btn-primary-action">
                <svg class="tab-icon" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-4 11H9v-5h6v5zm4-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-2-9H7v4h10V3z"></path>
                </svg>
                Download / Print Invoice
            </button>
            <button type="button" class="btn-action btn-secondary-action" data-close-modal="modalOrderDetails">Close</button>
        </div>
    </div>
</div>
