...
<head>
    ...
    <title>Saved Addresses - SchemeCraft</title>
    ...
    <div class="account-layout">
        ...
        <nav class="account-sidebar" aria-label="Account Navigation">
            <ul class="account-tabs">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/account/addresses" class="tab-link active">
                ...
                <li class="tab-logout-item">
                    <a href="${pageContext.request.contextPath}/logout" class="tab-link tab-logout">
        ...
        <section class="account-content">
            <div id="tab-addresses" class="tab-content active">
                <div class="card-panel">
                    <div class="panel-header-flex">
                        <h2 class="panel-title">Saved Addresses</h2>
                        <button type="button" id="btnOpenAddAddressModal" class="btn-action btn-primary-action btn-sm">+ Add New Address</button>
                    </div>

                    <div id="addressesContainer" class="address-grid margin-top-md">
...
<div id="modalAddAddress" class="modal-overlay">
    <div class="modal-card">
        <div class="modal-header">
            <h3 class="modal-title">Add New Address</h3>
            <button type="button" class="modal-close" data-close-modal="modalAddAddress">&times;</button>
        </div>
        <form id="formAddAddress" class="account-form">
            <div class="form-group">
                <label for="addrStreet" class="form-label">Street Address</label>
                <input type="text" id="addrStreet" name="streetAddress" class="form-control" required placeholder="e.g. 123 Crafter Lane">
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="addrCity" class="form-label">City</label>
                    <input type="text" id="addrCity" name="city" class="form-control" required placeholder="e.g. Blocktown">
                </div>
                <div class="form-group col-md-6">
                    <label for="addrState" class="form-label">State / Province</label>
                    <input type="text" id="addrState" name="stateProvince" class="form-control" placeholder="e.g. Redstone State">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="addrPostal" class="form-label">Postal / ZIP Code</label>
            ...
            <div class="modal-actions">
                <button type="button" class="btn-action btn-secondary-action" data-close-modal="modalAddAddress">Cancel</button>
                <button type="submit" class="btn-action btn-primary-action">Save Address</button>
            </div>
        </form>
    </div>
</div>
